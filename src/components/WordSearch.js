    ...
    <div className="container mt-5 text-center">
      ...
      {result && (
        ...
        >
          ...
          <p><strong>🔄 Synonyms:</strong> {result.synonyms.length > 0 ? result.synonyms.join(", ") : "N/A"}</p>
          <p><strong>🚫 Antonyms:</strong> {result.antonyms.length > 0 ? result.antonyms.join(", ") : "N/A"}</p>
